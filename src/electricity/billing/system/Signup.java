...
public class Signup extends JFrame implements ActionListener{
    JButton create,back;
    Choice accountType;
    JTextField meter,name,password;
    JTextField username;
    ...
    Signup(){
        ...
        panel.setBorder(new TitledBorder(new LineBorder(Color.WHITE,2),"Create-Account",TitledBorder.LEADING,TitledBorder.TOP,null,Color.WHITE));
        panel.setBackground(new Color(96,189,255));
